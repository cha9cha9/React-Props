...
import './App.css';
import Barnar from './componets/Barnar' 
...
function App() {
  ...
  return (
    <>
      <Barnar/> 
      <div>
      <Listcard city={data[0].city} description={data[0].description} img={data[0].imageUrl}/>
      <Listcard city={data[1].city} description={data[1].description} img={data[1].imageUrl}/>
      <Listcard city={data[2].city} description={data[2].description} img={data[2].imageUrl}/>
      <Listcard city={data[3].city} description={data[3].description} img={data[3].imageUrl}/>
      <Listcard city={data[4].city} description={data[4].description} img={data[4].imageUrl}/>
      </div>
